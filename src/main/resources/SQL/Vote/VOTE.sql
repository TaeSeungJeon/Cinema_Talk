...
ALTER TABLE VOTE_OPTION
    ADD CONSTRAINT PK_VOTE_OPTION PRIMARY KEY (
                                               vote_id,
                                               movie_id
        );

ALTER TABLE VOTE_RECORD
    ADD CONSTRAINT PK_VOTE_RECORD PRIMARY KEY (
                                               record_id
        );

ALTER TABLE VOTE_REGISTER
    ADD CONSTRAINT PK_VOTE_REGISTER PRIMARY KEY (
                                                 vote_id
        );


ALTER TABLE VOTE_OPTION
    ADD CONSTRAINT FK_VOTE_REGISTER_TO_VOTE_OPTION_1 FOREIGN KEY (
                                                                  vote_id
        )
...
ALTER TABLE VOTE_OPTION
    ADD CONSTRAINT FK_MOVIE_TO_VOTE_OPTION_1 FOREIGN KEY (
                                                          movie_id
        )
        REFERENCES MOVIE (
                          movie_id
