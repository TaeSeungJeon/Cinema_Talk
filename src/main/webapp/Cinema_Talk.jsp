...
<header>
    <a href="webapp/Cinema_Talk.jsp" class="glass-panel"
       style="padding: 10px 25px; font-weight: 700; color: var(--accent-color); font-size: 1.2rem;">Cinema Talk</a>
    ...
    <main>
        ...
        <section class="hero-section" id="hero-banner">
            <div class="hero-content">
                <a href="movieDetail.jsp?id=1" id="movie-title-link"
                ...
                <button id="objBtn"
                        ...
                        onclick="location.href='movieDetail.jsp?id=1'">상세 데이터 불러오기
                </button>
            </div>
        ...
        const movies = [
            {
                id: 1,
                title: "범죄도시 3",
                info: "범죄, 액션 • 현재 인기 순위 1위",
                color: "linear-gradient(to right, #6366f1 0%, #4338ca 50%, #1e1b4b 100%)"
            },
            {
                id: 2,
                title: "아바타: 물의 길",
                info: "SF, 어드벤처 • 현재 인기 순위 2위",
                color: "linear-gradient(to right, #0ea5e9 0%, #0369a1 50%, #082f49 100%)"
            },
            {
                id: 3,
                title: "더 퍼스트 슬램덩크",
                info: "애니메이션, 스포츠 • 현재 인기 순위 3위",
                color: "linear-gradient(to right, #f43f5e 0%, #be123c 50%, #4c0519 100%)"
            }
        ];
