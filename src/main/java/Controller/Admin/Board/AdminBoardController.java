...
public class AdminBoardController implements Action {
    ...
    public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<BoardDTO> list = service.getBoardList(sort, searchType, keyword, startRow, endRow);
        ...
        if (isAjax) {
            forward.setPath("/WEB-INF/views/admin/board/adminBoard.jsp");
        } else {
            request.setAttribute("contentPage", "/WEB-INF/views/admin/board/adminBoard.jsp");
