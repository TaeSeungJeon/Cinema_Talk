	...
	<div class="container">
		<main>
			...
			<div class="pagination">
				<c:if test="${page > 1}">
					<a
						href="${pageContext.request.contextPath}/notice.do?page=${page - 1}&filter=notice"
						class="page-btn"><</a>
				</c:if>
				...
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
					<c:choose>
						...
						<c:otherwise>
							<a
								href="${pageContext.request.contextPath}/notice.do?page=${i}&filter=notice"
								class="page-btn">${i}</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				...
				<c:if test="${endPage < maxPage}">
					...
					<a
						href="${pageContext.request.contextPath}/notice.do?page=${endPage + 1}&filter=notice"
	...
	<div class="modal-overlay" id="writeModal">
		<div class="write-modal">
			...
			<form method="post"
				...
				<!-- 내용 -->
				<textarea rows="12" placeholder="공지사항을 작성해주세요."
